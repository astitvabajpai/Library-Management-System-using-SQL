...
-- Task 10 :ist Employees with Their Branch Manager's Name and their branch details:
SELECT 
    e1.emp_id,
    e1.emp_name,
    e1.position,
...
(
  ...
  DATE_SUB(CURDATE(), INTERVAL 24 DAY),
...
COUNT(rs.issued_id) AS number_book_return,
...
-- CREATE TABLE AS (CTAS) statement to create a new table active_members containing members who have issued at least one book in the last 2 months.
...
-- Testig the procedure
-- View all books
SELECT * FROM books;

-- View issued status table
SELECT * FROM issued_status;

-- Test the procedure: available book
CALL issue_book('IS155', 'C108', '978-0-553-29698-2', 'E104');

-- Test the procedure: unavailable book
